    ...
    <div className="space-y-2">
          ...
          return (
            <label
              ...
              className={`flex items-center gap-2 px-2 py-1.5 rounded cursor-pointer transition-colors
                ${isActive ? 'bg-orange-900/30 text-orange-300' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/50'}`}
            >
              <input
                type="checkbox"
                checked={isActive}
      ...
      {anyActive && (
        <div className="space-y-2 mt-2 pt-2 border-t border-gray-700/30">
          ...
          {/* 팔레트 선택 */}
          <div>
            <div className="text-[10px] text-gray-400 mb-1">Palette</div>
                ...
                <button
                  ...
                  className={`text-[9px] font-mono px-2 py-0.5 rounded border transition-colors
                    ${heatmapParams.palette === p.id
                      ...
                      : 'border-gray-600/40 text-gray-500 hover:text-gray-300 hover:bg-gray-800/30'
                    }`}
                >
                  {p.label}
                </button>
