...
export const BUILTIN_RULES_DSL: RuleDSL[] = [
  ...
  { id: 'dark-vessel-chokepoint', name: 'Dark Vessel near Chokepoint', description: 'Ship with AIS gap 30min+ detected within 100km of a strategic chokepoint', enabled: true, severity: 'critical', triggerLayer: 'dark_vessels', targetLayer: 'chokepoints', spatialRadius: 100, temporalWindow: 3600, cooldown: 1800, conditions: { minTargetCount: 1 }, triggerCount: 0, lastTriggered: null, createdAt: now, updatedAt: now, isBuiltin: true },
];
