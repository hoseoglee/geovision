 ...
 * 336 cameras (excludes 24 entries already in STATIC_CCTVS in CCTVProvider.ts)
 * Expanded 2026-03-25: Added Americas, Middle East, Africa, Oceania, Europe, Asia streams
 */
...
export const PUBLIC_CCTVS: CCTVData[] = [
  ...
  {
    id: 'kamakura-shichirigahama-1',
    name: 'Shichirigahama Beach',
    city: 'Kamakura',
    country: 'JP',
    lat: 35.3087,
    lng: 139.5100,
    embedUrl: 'https://www.youtube.com/embed/JN_Ws9-Hj6A?autoplay=1&mute=1',
    type: 'webcam',
    source: 'static',
  },
  {
  ...
  // =================================================================
  // ADDITIONAL YOKOHAMA, JAPAN
  // =================================================================
  {
    id: 'yokohama-minatomirai-1',
    name: 'Minatomirai Yokohama',
    city: 'Yokohama',
    country: 'JP',
    lat: 35.4555,
    lng: 139.6326,
    embedUrl: 'https://www.youtube.com/embed/x3P3N3VGvtU?autoplay=1&mute=1',
    type: 'city',
    source: 'static',
  },

  // =================================================================
  // ADDITIONAL OKINAWA/NAHA, JAPAN
  // =================================================================
  {
  ...
  {
    id: 'okinawa-naha-airport-1',
    name: 'Naha Airport Okinawa',
    city: 'Naha',
    country: 'JP',
    lat: 26.1959,
    lng: 127.6468,
    embedUrl: 'https://www.youtube.com/embed/sAePgqzfOdY?autoplay=1&mute=1',
    type: 'traffic',
    source: 'static',
  },
  {
  ...
  {
    id: 'okinawa-ishigaki-1',
    name: 'Ishigaki Island',
    city: 'Ishigaki',
    country: 'JP',
    lat: 24.3448,
    lng: 124.1553,
    embedUrl: 'https://www.youtube.com/embed/h794owDyuGk?autoplay=1&mute=1',
    type: 'webcam',
    source: 'static',
  },
  {
  ...
  // =================================================================
  // ADDITIONAL NAGOYA, JAPAN
  // =================================================================
  {
    id: 'nagoya-station-railway-1',
    name: 'Nagoya Station Railway View',
    city: 'Nagoya',
    country: 'JP',
    lat: 35.1709,
    lng: 136.8820,
    embedUrl: 'https://www.youtube.com/embed/ReaY2O3ly1w?autoplay=1&mute=1',
    type: 'city',
    source: 'static',
  },

  // =================================================================
  // ADDITIONAL SAPPORO, JAPAN
  // =================================================================
  {
  ...
  {
    id: 'sapporo-moiwa-1',
    name: 'Mt. Moiwa Observation Deck',
    city: 'Sapporo',
    country: 'JP',
    lat: 43.0235,
    lng: 141.3280,
    embedUrl: 'https://www.youtube.com/embed/FmtX2lJLoJY?autoplay=1&mute=1',
    type: 'landmark',
    source: 'static',
  },

  // =================================================================
  // NARITA / KANSAI AIRPORTS, JAPAN
  // =================================================================
  {
    id: 'narita-airport-1',
  ...
  {
    id: 'cape-town-muizenberg',
    name: 'Muizenberg Beach Cape Town',
    city: 'Cape Town',
    country: 'ZA',
    lat: -34.1091,
    lng: 18.4710,
    embedUrl: 'https://www.youtube.com/embed/ODAMNg5T8RY?autoplay=1&mute=1',
    type: 'webcam',
    source: 'static',
  },
  {
  ...
  {
    id: 'mallorca-playa-muro',
    name: 'Mallorca Playa de Muro',
    city: 'Muro',
    country: 'ES',
    lat: 39.8027,
    lng: 3.1014,
    embedUrl: 'https://www.youtube.com/embed/fH3h_6yoK6s?autoplay=1&mute=1',
    type: 'webcam',
    source: 'static',
  },
  {
  ...
  // =================================================================
  // MIDDLE EAST & AFRICA — EXPANDED (2026-03-25)
  // =================================================================
